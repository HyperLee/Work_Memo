...
原始題目、需求與參考連結保留於 替換空格/替換空格/Program.cs 的 XML 註解。
...
dotnet restore 替換空格/替換空格/替換空格.csproj
dotnet build 替換空格/替換空格/替換空格.csproj --nologo
dotnet run --project 替換空格/替換空格/替換空格.csproj --no-build --nologo

本機只有 .NET 10 runtime；net8.0 可執行時使用：
DOTNET_ROLL_FORWARD=Major dotnet run --project 替換空格/替換空格/替換空格.csproj --no-build --nologo
...
Actual: We%20Are%20Happy
PASS-FAIL: PASS

Case: 題目範例 / StringBuilder 逆向
Expected: We%20Are%20Happy
Actual: We%20Are%20Happy
PASS-FAIL: PASS
...
Case: 單一空格 / StringBuilder 逆向
Expected: %20
Actual: %20
PASS-FAIL: PASS

Case: 前後空格 / 手動走訪
Expected: %20%20Leading%20and%20trailing%20%20
Actual: %20%20Leading%20and%20trailing%20%20
PASS-FAIL: PASS

Case: 前後空格 / StringBuilder 逆向
Expected: %20%20Leading%20and%20trailing%20%20
Actual: %20%20Leading%20and%20trailing%20%20
PASS-FAIL: PASS

Case: 連續空格 / 手動走訪
Expected: A%20B%20%20C%20%20%20D
Actual: A%20B%20%20C%20%20%20D
PASS-FAIL: PASS

Case: 連續空格 / StringBuilder 逆向
Expected: A%20B%20%20C%20%20%20D
Actual: A%20B%20%20C%20%20%20D
PASS-FAIL: PASS
