...
原始題目、需求與參考連結保留於 平行處理-Parallel練習/平行處理-Parallel練習/Program.cs 的 XML 註解。
...
dotnet restore 平行處理-Parallel練習/平行處理-Parallel練習/平行處理-Parallel練習.csproj
dotnet build 平行處理-Parallel練習/平行處理-Parallel練習/平行處理-Parallel練習.csproj --nologo
dotnet run --project 平行處理-Parallel練習/平行處理-Parallel練習/平行處理-Parallel練習.csproj --no-build --nologo

本機只有 .NET 10 runtime；net8.0 可執行時使用：
DOTNET_ROLL_FORWARD=Major dotnet run --project 平行處理-Parallel練習/平行處理-Parallel練習/平行處理-Parallel練習.csproj --no-build --nologo
...
```text
.
├── 平行處理-Parallel練習/平行處理-Parallel練習/
│   ├── Program.cs
│   └── 平行處理-Parallel練習.csproj
├── .editorconfig
├── .gitattributes
├── .gitignore
├── AGENTS.md
