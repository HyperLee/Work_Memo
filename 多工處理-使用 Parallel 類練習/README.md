# 多工處理-使用 Parallel 類練習

這個 net8.0 主控台專案保留原始演算法與公開方法，並以固定 smoke test 驗證結果。

## 題目或原始需求說明

原始題目、需求與參考連結保留於 多工處理-使用 Parallel 類練習/多工處理-使用 Parallel 類練習/Program.cs 的 XML 註解。
...
dotnet restore 多工處理-使用 Parallel 類練習/多工處理-使用 Parallel 類練習/多工處理-使用 Parallel 類練習.csproj
dotnet build 多工處理-使用 Parallel 類練習/多工處理-使用 Parallel 類練習/多工處理-使用 Parallel 類練習.csproj --nologo
dotnet run --project 多工處理-使用 Parallel 類練習/多工處理-使用 Parallel 類練習/多工處理-使用 Parallel 類練習.csproj --no-build --nologo

本機只有 .NET 10 runtime；net8.0 可執行時使用：
DOTNET_ROLL_FORWARD=Major dotnet run --project 多工處理-使用 Parallel 類練習/多工處理-使用 Parallel 類練習/多工處理-使用 Parallel 類練習.csproj --no-build --nologo
...
```text
.
├── 多工處理-使用 Parallel 類練習/多工處理-使用 Parallel 類練習/
│   ├── Program.cs
│   └── 多工處理-使用 Parallel 類練習.csproj
├── .editorconfig
├── .gitattributes
├── .gitignore
├── AGENTS.md
