...
原始題目、需求與參考連結保留於 二維陣列輸出/二維陣列輸出/Program.cs 的 XML 註解。
...
dotnet restore 二維陣列輸出/二維陣列輸出/二維陣列輸出.csproj
dotnet build 二維陣列輸出/二維陣列輸出/二維陣列輸出.csproj --nologo
dotnet run --project 二維陣列輸出/二維陣列輸出/二維陣列輸出.csproj --no-build --nologo

本機只有 .NET 10 runtime；net8.0 可執行時使用：
DOTNET_ROLL_FORWARD=Major dotnet run --project 二維陣列輸出/二維陣列輸出/二維陣列輸出.csproj --no-build --nologo
...
Actual: [1,1]|[1,2]|[2,2]|[2,1]|[2,0]|[1,0]|[0,0]|[0,1]|[0,2]
PASS-FAIL: PASS
