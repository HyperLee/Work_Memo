...
原始題目、需求與參考連結保留於 Grid題目類型解法/Grid題目類型解法/Program.cs 的 XML 註解。
...
dotnet restore Grid題目類型解法/Grid題目類型解法/Grid題目類型解法.csproj
dotnet build Grid題目類型解法/Grid題目類型解法/Grid題目類型解法.csproj --nologo
dotnet run --project Grid題目類型解法/Grid題目類型解法/Grid題目類型解法.csproj --no-build --nologo

本機只有 .NET 10 runtime；net8.0 可執行時使用：
DOTNET_ROLL_FORWARD=Major dotnet run --project Grid題目類型解法/Grid題目類型解法/Grid題目類型解法.csproj --no-build --nologo
