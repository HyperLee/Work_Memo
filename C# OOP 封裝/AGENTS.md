...
This directory contains the .NET 10 console project `C# OOP 封裝`.

- `C# OOP 封裝/C# OOP 封裝.csproj` is the SDK-style executable project targeting `net10.0`.
- `C# OOP 封裝/Program.cs` is the preserved console entry point and teaching example.
- `C# OOP 封裝.sln` remains the solution entry point for solution-level builds.
...
Restore resolves dependencies, build compiles the solution, and run executes the console smoke test. In VS Code, F5 uses the `Debug C# OOP 封裝` configuration and its matching build task.
