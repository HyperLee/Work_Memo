...
原始題目、需求與參考連結保留於 Floyd-Warshall算法/Floyd-Warshall算法/Program.cs 的 XML 註解。
...
dotnet restore Floyd-Warshall算法/Floyd-Warshall算法/Floyd-Warshall算法.csproj
dotnet build Floyd-Warshall算法/Floyd-Warshall算法/Floyd-Warshall算法.csproj --nologo
dotnet run --project Floyd-Warshall算法/Floyd-Warshall算法/Floyd-Warshall算法.csproj --no-build --nologo

本機只有 .NET 10 runtime；net8.0 可執行時使用：
DOTNET_ROLL_FORWARD=Major dotnet run --project Floyd-Warshall算法/Floyd-Warshall算法/Floyd-Warshall算法.csproj --no-build --nologo
...
Actual: 0,3,5,6;5,0,2,3;3,6,0,1;2,5,7,0
PASS-FAIL: PASS
[graph=2]
Expected: 0,4,6;INF,0,2;INF,INF,0
Actual: 0,4,6;INF,0,2;INF,INF,0
PASS-FAIL: PASS
