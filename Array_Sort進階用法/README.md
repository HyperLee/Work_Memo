...
原始題目、需求與參考連結保留於 Array_Sort進階用法/Array_Sort進階用法/Program.cs 的 XML 註解。
...
dotnet restore Array_Sort進階用法/Array_Sort進階用法/Array_Sort進階用法.csproj
dotnet build Array_Sort進階用法/Array_Sort進階用法/Array_Sort進階用法.csproj --nologo
dotnet run --project Array_Sort進階用法/Array_Sort進階用法/Array_Sort進階用法.csproj --no-build --nologo

本機只有 .NET 10 runtime；net8.0 可執行時使用：
DOTNET_ROLL_FORWARD=Major dotnet run --project Array_Sort進階用法/Array_Sort進階用法/Array_Sort進階用法.csproj --no-build --nologo
...
```text
.
├── Array_Sort進階用法/Array_Sort進階用法/
│   ├── Program.cs
│   └── Array_Sort進階用法.csproj
├── .editorconfig
├── .gitattributes
├── .gitignore
├── AGENTS.md
